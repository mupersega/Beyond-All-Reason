...
function init()
	...
	options = {
		...
		{ id = "rml_debugger", group = "dev", category = types.dev, name = widgetOptionColor .. "  " .. "RmlUi Debugger", type = "bool", value = false, description = "Toggle the RmlUi debugger overlay (developer tool).",
		  onchange = function(_, value)
			  if RmlUi then
